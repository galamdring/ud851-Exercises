...
public class NotificationUtils {
    private static final String CHANNEL_ID = "WaterReminderChannelId";
    ...
    public static void remindUserBecauseCharging(Context context) {
        ...
        manager.notify("Water Reminder", 12345, builder.build());
    }
    private static final int WATER_REMINDER_PENDING_INTENT_ID = 12345;
