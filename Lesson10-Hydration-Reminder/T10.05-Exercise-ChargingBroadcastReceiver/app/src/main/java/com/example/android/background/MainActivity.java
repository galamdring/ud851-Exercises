...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Completed TODO (5) Create and instantiate a new instance variable for your ChargingBroadcastReceiver
        // and an IntentFilter
        chargingIntentFilter = new IntentFilter(Intent.ACTION_POWER_DISCONNECTED);
        chargingBroadcastReceiver = new ChargingBroadcastReceiver();
        // Completed TODO (6) Call the addAction method on your intent filter and add Intent.ACTION_POWER_CONNECTED
