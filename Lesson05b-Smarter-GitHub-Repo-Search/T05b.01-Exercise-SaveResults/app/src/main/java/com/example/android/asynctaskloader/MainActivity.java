...
public class MainActivity extends AppCompatActivity {
    ...
    static final String URL_KEY_STRING = "querykeystring";

    // TODO (2) Create a static final key to store the search's raw JSON
    static final String RESULT_KEY_STRING = "resultKeyString";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState!=null){
            if(savedInstanceState.containsKey(URL_KEY_STRING)){
                mUrlDisplayTextView.setText(savedInstanceState.getString(URL_KEY_STRING));
            }
            if(savedInstanceState.containsKey(RESULT_KEY_STRING)){
                mSearchResultsTextView.setText(savedInstanceState.getString(RESULT_KEY_STRING));
            }
        }
    }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putString(URL_KEY_STRING,urlText);
        ...
        outState.putString(RESULT_KEY_STRING,results);
    }
